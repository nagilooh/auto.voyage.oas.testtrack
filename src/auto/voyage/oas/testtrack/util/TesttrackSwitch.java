 ...
 * @generated
 */
public class TesttrackSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TesttrackPackage.ROAD_SEGMENT: {
				RoadSegment roadSegment = (RoadSegment)theEObject;
				T result = caseRoadSegment(roadSegment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TesttrackPackage.ACTOR: {
				Actor actor = (Actor)theEObject;
				T result = caseActor(actor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TesttrackPackage.TRACK_SEGMENT: {
				TrackSegment trackSegment = (TrackSegment)theEObject;
				T result = caseTrackSegment(trackSegment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TesttrackPackage.ROAD_COMPONENT: {
				RoadComponent roadComponent = (RoadComponent)theEObject;
				T result = caseRoadComponent(roadComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TesttrackPackage.LANE: {
				Lane lane = (Lane)theEObject;
				T result = caseLane(lane);
				if (result == null) result = caseRoadComponent(lane);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TesttrackPackage.SIDEWALK: {
				Sidewalk sidewalk = (Sidewalk)theEObject;
				T result = caseSidewalk(sidewalk);
				if (result == null) result = caseRoadComponent(sidewalk);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TesttrackPackage.ACTION: {
				Action action = (Action)theEObject;
				T result = caseAction(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TesttrackPackage.SIGN: {
				Sign sign = (Sign)theEObject;
				T result = caseSign(sign);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TesttrackPackage.CROSSWALK: {
				Crosswalk crosswalk = (Crosswalk)theEObject;
				T result = caseCrosswalk(crosswalk);
				if (result == null) result = caseSign(crosswalk);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TesttrackPackage.STOP_SIGN: {
				StopSign stopSign = (StopSign)theEObject;
				T result = caseStopSign(stopSign);
				if (result == null) result = caseSign(stopSign);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TesttrackPackage.GIVE_WAY_SIGN: {
				GiveWaySign giveWaySign = (GiveWaySign)theEObject;
				T result = caseGiveWaySign(giveWaySign);
				if (result == null) result = caseSign(giveWaySign);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseRoadSegment(RoadSegment object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Road Component</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Road Component</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRoadComponent(RoadComponent object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sidewalk</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sidewalk</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSidewalk(Sidewalk object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Crosswalk</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Crosswalk</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Stop Sign</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Stop Sign</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStopSign(StopSign object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Give Way Sign</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Give Way Sign</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
